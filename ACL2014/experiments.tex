...
For each query, a high dimensional and sparse feature vector was created over clicked urls (the number of usrls is a few billion).   
Specifically, each dimension in the feature vector of a query $q$ corresponds to a webpage (urls) that have received a user click for $q$. The weight of 
