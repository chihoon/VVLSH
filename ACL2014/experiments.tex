...
$\qvec = (f_1, f_2, \cdots, f_D)$, where $f_i$ is a click through rate of url $i$ and query $q$. Note that in our real implementation, $\qvec$ follows a spare representaion omitting dimensions with zero click through rate.
